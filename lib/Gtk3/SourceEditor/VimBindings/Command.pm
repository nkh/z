...
sub _build_desc_map {
    return {
        ...
        viewport_top      => 'viewport top (H)',     viewport_middle => 'viewport mid (M)',
        viewport_bottom   => 'viewport bot (L)',     viewport_center => 'viewport center (zz)',
        ...
        delete_char       => 'delete char',          delete_char_backward => 'delete char back (X)',  backspace     => 'backspace',
